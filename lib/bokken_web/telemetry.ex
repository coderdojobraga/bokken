defmodule BokkenWeb.Telemetry do
  @moduledoc """
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("bokken.repo.query.total_time", unit: {:native, :millisecond}),
      summary("bokken.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("bokken.repo.query.query_time", unit: {:native, :millisecond}),
      summary("bokken.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("bokken.repo.query.idle_time", unit: {:native, :millisecond}),
